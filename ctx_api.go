...
func (ctx *Ctx) ReleasePrimaryCtx(dev Device) {
	Cdev := C.CUdevice(dev)
	f := func() error {
...
func (ctx *Ctx) SetPrimaryCtxFlags(dev Device, flags ContextFlags) {
	Cdev := C.CUdevice(dev)
	Cflags := C.uint(flags)
	f := func() error {
...
func (ctx *Ctx) PrimaryCtxState(dev Device) (flags uint, active int, err error) {
	...
	if err = ctx.Do(f); err != nil {
		err = errors.Wrap(err, "PrimaryCtxState")
	}
	flags = uint(Cflags)
	active = int(Cactive)
	return
...
func (ctx *Ctx) ResetPrimaryCtx(dev Device) {
	Cdev := C.CUdevice(dev)
	f := func() error {
...
func (ctx *Ctx) PopCurrentCtx() (pctx CUContext, err error) {
	...
	if err = ctx.Do(f); err != nil {
		err = errors.Wrap(err, "PopCurrentCtx")
	}
	pctx = makeContext(Cpctx)
	return
}

func (ctx *Ctx) SetCurrentContext() {
	Cctx := ctx.c()
	f := func() error {
...
func (ctx *Ctx) CurrentContext() (pctx CUContext, err error) {
	...
	if err = ctx.Do(f); err != nil {
		err = errors.Wrap(err, "CurrentContext")
	}
	pctx = makeContext(Cpctx)
	return
}
...
func (ctx *Ctx) CurrentDevice() (device Device, err error) {
	...
	if err = ctx.Do(f); err != nil {
		err = errors.Wrap(err, "CurrentDevice")
	}
...
func (ctx *Ctx) CurrentFlags() (flags uint, err error) {
	...
	if err = ctx.Do(f); err != nil {
		err = errors.Wrap(err, "CurrentFlags")
	}
	flags = uint(Cflags)
	return
}
